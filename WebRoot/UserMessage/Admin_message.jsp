                ...
                <div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
                    	<div class="card">
							...
							<div class="card-action">发送系统消息：</div>
							<form class="card-content" action="AddSystemMessage" method="post" accept-charset="UTF-8">
								<p>
									<textarea name="Info" style="resize: none;width:100%;height:120px;">发送系统消息</textarea>
								</p>
								<div align="right" style="margin-top:10px;">
									<i class="waves-effect waves-light btn waves-input-wrapper" style="">
										<input class="waves-button-input"  type="submit" value="发送">
									</i>
								</div>
							</form>
						...
						<s:iterator value="messages" var="obj">
							<div class="topxian marbottom10">
								...
								<div class="UserPL" style="margin-bottom:20px;margin-left:20px">
									...
									<p class="" style="text-align:right;color:#808080;font-size:12px;margin-top:20px"><s:property value="Time"/>　<a href="DeleteSystemMessage?id=<%=request.getAttribute("Id") %>">删除</a>&nbsp;&nbsp;&nbsp;</p>
								</div>
							</div>
						</s:iterator>
					<!--这结束-->
