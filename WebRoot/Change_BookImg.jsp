        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="height300 card">
                        ...
                        <form class="card-content" action="UpdateBookImg?book_id=<%=request.getParameter("book_id") %>" method="post"  ENCTYPE="multipart/form-data"">
                           <div class="file-field input-field" >
                                <div class="btn">
                                    <p>上传</p>
                                    <input type="file" multiple name="myUpload">
                                </div>
