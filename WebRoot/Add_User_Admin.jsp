                	...
                	<div class="col-md-6 col-sm-12 col-xs-12">
                    	<div class="card">
                        	...
                        	<div class="height500 card-content">
                            	<form action="AddUser-bean.jsp?Pages=tianjia" method="post" accept-charset="UTF-8">
                                	<div class="zitiyanse">
                                    	<p>账号：</p>
                                    	<input name="Id" class="form-control"  placeholder="账号" required />
                                    	<p>密码：</p>
                                    	<input name="Name" class="form-control"  placeholder="密码" required />
                                    	<p>昵称：</p>
                       	             	<input name="Password" class="form-control"  placeholder="昵称" required />
                                    	<p>联系方式：</p>
                                    	<input name="Tel" class="form-control"  placeholder="联系方式" required />
                                	</div>
                                	<div align="right">
