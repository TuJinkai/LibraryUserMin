...
<html>
  ...
  <body><s:iterator value="user" var="obj">
            ...
            <div id="page-inner">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="height500 card-content">
                            <form action="UpdateUserNameAndTel.action" method="post" accept-charset="UTF-8">
                                <div class="zitiyanse">
                                    <p>昵称：</p>
                                    <input name="name" class="form-control"  value="<%=request.getAttribute("Name").toString() %>" required />
                                    <p>联系方式：</p>
                                    <input name="tel" class="form-control"  value="<%=request.getAttribute("Tel").toString() %>" required />
                                </div>
                                <div align="right">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form class="card-content" action="Change_UserImg.jsp" method="post" accept-charset="UTF-8">
                            <img class="tupian" src="<%=request.getAttribute("Img").toString() %>">
                            <div align="right">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form class="card-content"  action="UpdateUserInfo.action" method="post" accept-charset="UTF-8">
                            <p><textarea name="User_Info" style="resize: none;width:100%;height:165px;"><%=request.getAttribute("User_Info").toString() %></textarea></p>
