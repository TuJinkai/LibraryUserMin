...
<html>
  ...
  <body><s:iterator value="book" var="obj">
<!-- 导航栏 -->
<nav class="bigM">
    <div class="m">
        <div class="collapse navbar-collapse">
            ...
            <form class="navbar-form" role="form"  action="BookFind.action"   method="post" accept-charset="UTF-8">
...
<div class="m1">
    <div class="article-profile-section article-profile-primary">
        ...
        <div class="">
            ...
            <div class="YD">
               ...
               <%try{ %>
               <%if(request.getSession().getAttribute("level").toString().equals("1")) {%> <a href="ShowBookInfo?book_id=<%=request.getAttribute("Book_Id") %>&bookurl=page" class="btn btnYellow">
        ...
        <div class="">
            <div class="">
                <div class="info">
                    ...
                    <textarea disabled="disabled" style="resize: none;border:none;background:#fffff9;width:100%;height:500px;"><s:property value="Book_Info"/></textarea>
    ...
    <div class="article-profile-section reviews">
        ...
        <div class="PLK">
			<div class="Input_Box">  
				<form action="AddComments.action?book_id=<%=request.getParameter("book_id") %>" method="post" accept-charset="UTF-8">
        ...
        <div>
        	...
        	<div class="topxian marbottom10">
        		<div class="UserImg">
        			<img style="width:70px;height:70px;" alt="这里要显示用户名" src="<%=rs.getString("Img") %>">
        		</div>
        		<div class="UserPL">
        			<a class="Namecolor" href="#!" style="color:#0e27be;" onmouseover="this.style.color='#7984c7'" onmouseout="this.style.color='#0e27be'"><%=rs.getString("Name") %>:</a>
